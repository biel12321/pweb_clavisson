...
import br.unisul.pweb.quarta.repositories.ItemPedidoRepository;
import br.unisul.pweb.quarta.repositories.PedidoRepository;
...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Jurupinga dos santos", "jurupinga@gmail.com", "15428796583", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("48999939244", "48988120785"));
		
		Endereco en1 = new Endereco(null, "Almir Santos Miranda ", "283", "Apto 402", "Dehon"     , "88704110", cli1, c2);
		Endereco en2 = new Endereco(null, "Hermínio João Santana", "211", "Casa"    , "Pouso Alto", "88735000", cli1, c3);
